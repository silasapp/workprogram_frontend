...
@Component({
  selector: 'app-allapprovals',
  templateUrl: './allapprovals.component.html',
  styleUrls: ['./allapprovals.component.scss']
})
export class AllapprovalsComponent implements OnInit {
    selectedColumns: any[] = [];
    genk: GenericService;
    columnHeader = [];
    columnValue = [];
    ...
    getApplications() {
      this.workprogram.getApplications()
        .subscribe(res => {
