...
import { budgetActualExpenditure, developmentDrillingActivities, exploratoryActivities, facilitiesDevelopmentProject, productionCost } from 'src/app/models/step3-budget-performance.model';
...
export class SWPBudgetPerformanceComponent implements OnInit {
  ...
  facilitiesDevelopmentBody: facilitiesDevelopmentProject = {} as facilitiesDevelopmentProject;
  ...
  getBudgetData() {
    this.workprogram.getFormThreeBudget(this.genk.OmlName, this.genk.wpYear, this.genk.fieldName)
    .subscribe(res => {
      ...
      if(res.budgetPerformanceExploratory != null && res.budgetPerformanceExploratory.length > 0){
        exploratoryInfo = res.budgetPerformanceExploratory[0] as exploratoryActivities;
        this.loadTable_Exploratory(res.budgetPerformanceExploratory);
      }
      if(res.budgetPerformanceDevelopment != null && res.budgetPerformanceDevelopment.length > 0){
        developmentDrillingInfo = res.budgetPerformanceDevelopment[0] as developmentDrillingActivities;
        this.loadTable_Development(res.budgetPerformanceDevelopment);
      }
      if(res.budgetPerformanceProductionCost !=null && res.budgetPerformanceProductionCost.length > 0){
        productionCostInfo = res.budgetPerformanceProductionCost[0] as productionCost;
        this.loadTable_Production(res.budgetPerformanceProductionCost);
      }
      if(res.budgetPerformanceFacilityDevProjects != null && res.budgetPerformanceFacilityDevProjects.length > 0){
       facilitiesDevelopmentInfo = res.budgetPerformanceFacilityDevProjects[0] as facilitiesDevelopmentProject;
        this.loadTable_Facility(res.budgetPerformanceFacilityDevProjects);
      }

      this.budgetBody = budgetInfo;
      this.exploratoryBody = exploratoryInfo; this.developmentDrillingBody= developmentDrillingInfo; this.facilitiesDevelopmentBody = facilitiesDevelopmentInfo;
  ...
  ngOnInit(): void {
    ...
    this.budgetActualExpenditureForm = new FormGroup({
      ...
      budget_for_other_Activities_NGN: new FormControl(this.budgetBody.budget_for_other_Activities_NGN, Validators.required),
      budget_for_other_Activities_USD: new FormControl(this.budgetBody.budget_for_other_Activities_USD, Validators.required),
      equivalent_Naira_and_Dollar_Component_NGN: new FormControl(this.budgetBody.equivalent_Naira_and_Dollar_Component_NGN, Validators.required),
      equivalent_Naira_and_Dollar_Component_USD: new FormControl(this.budgetBody.equivalent_Naira_and_Dollar_Component_USD, Validators.required)
    });
    this.exploratoryActivitiesForm = new FormGroup({
      aCQUISITION_planned: new FormControl(this.exploratoryBody.acquisitioN_planned, Validators.required),
      aCQUISITION_Actual: new FormControl(this.exploratoryBody.acquisitioN_Actual, Validators.required),
      pROCESSING_planned: new FormControl(this.exploratoryBody.processinG_planned, Validators.required),
      pROCESSING_Actual: new FormControl(this.exploratoryBody.processinG_Actual, Validators.required),
      rEPROCESSING_planned: new FormControl(this.exploratoryBody.reprocessinG_planned, Validators.required),
      rEPROCESSING_Actual: new FormControl(this.exploratoryBody.reprocessinG_Actual, Validators.required),
      eXPLORATION_planned: new FormControl(this.exploratoryBody.exploratioN_planned, Validators.required),
      eXPLORATION_Actual: new FormControl(this.exploratoryBody.exploratioN_Actual, Validators.required),
      aPPRAISAL_planned: new FormControl(this.exploratoryBody.appraisaL_planned, Validators.required),
      aPPRAISAL_Actual: new FormControl(this.exploratoryBody.appraisaL_Actual, Validators.required),
    });
    this.developmentDrillingForm = new FormGroup({
      dEVELOPMENT_planned: new FormControl(this.developmentDrillingBody.developmenT_planned, Validators.required),
      dEVELOPMENT_Actual: new FormControl(this.developmentDrillingBody.developmenT_Actual, Validators.required),
      wORKOVER_planned: new FormControl(this.developmentDrillingBody.workoveR_planned, Validators.required),
      wORKOVER_Actual: new FormControl(this.developmentDrillingBody.workoveR_Actual, Validators.required),
      cOMPLETION_planned: new FormControl(this.developmentDrillingBody.completioN_planned, Validators.required),
      cOMPLETION_Actual: new FormControl(this.developmentDrillingBody.completioN_Actual, Validators.required),
    });
    this.facilitiesDevelopmentForm = new FormGroup({
      concepT_planned : new FormControl(this.facilitiesDevelopmentBody.concepT_planned, Validators.required),
      concepT_Actual : new FormControl(this.facilitiesDevelopmentBody.concepT_Actual, Validators.required),
      feeD_planned : new FormControl(this.facilitiesDevelopmentBody.feeD_planned, Validators.required),
      feeD_COST_Actual : new FormControl(this.facilitiesDevelopmentBody.feeD_COST_Actual, Validators.required),
      detaileD_ENGINEERING_planned: new FormControl(this.facilitiesDevelopmentBody.detaileD_ENGINEERING_planned, Validators.required),
      detaileD_ENGINEERING_Actual: new FormControl(this.facilitiesDevelopmentBody.detaileD_ENGINEERING_Actual, Validators.required),
      procuremenT_planned: new FormControl(this.facilitiesDevelopmentBody.procuremenT_planned, Validators.required),
      procuremenT_Actual: new FormControl(this.facilitiesDevelopmentBody.procuremenT_Actual, Validators.required),
      constructioN_FABRICATION_planned: new FormControl(this.facilitiesDevelopmentBody.constructioN_FABRICATION_planned, Validators.required),
      constructioN_FABRICATION_Actual: new FormControl(this.facilitiesDevelopmentBody.constructioN_FABRICATION_Actual, Validators.required),
      installatioN_planned: new FormControl(this.facilitiesDevelopmentBody.installatioN_planned, Validators.required),
      installatioN_Actual: new FormControl(this.facilitiesDevelopmentBody.installatioN_Actual, Validators.required),
      upgradE_MAINTENANCE_planned: new FormControl(this.facilitiesDevelopmentBody.upgradE_MAINTENANCE_planned, Validators.required),
      upgradE_MAINTENANCE_Actual: new FormControl(this.facilitiesDevelopmentBody.upgradE_MAINTENANCE_Actual, Validators.required),
      decommissioninG_ABANDONMENT: new FormControl(this.facilitiesDevelopmentBody.decommissioninG_ABANDONMENT, Validators.required),
    }
    );
    this.productionCostForm = new FormGroup({
      direcT_COST_planned: new FormControl(this.productionCostBody.direcT_COST_planned, Validators.required),
