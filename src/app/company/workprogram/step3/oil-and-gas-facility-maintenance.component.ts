...
import { facilitiesProjectPerformance, newTechnologyAndConformityAssessment, oilAndGasFacilityMaintenanceProject } from 'src/app/models/step3-budget-facility-maintenance.model';
...
export class SWPOilAndGasFacilityMaintenanceComponent implements OnInit {
  ...
  oilAndGasBody: oilAndGasFacilityMaintenanceProject = {} as oilAndGasFacilityMaintenanceProject;
  newTechnologyBody : newTechnologyAndConformityAssessment = {} as newTechnologyAndConformityAssessment;
  facilitiesProjectPerformanceBody: facilitiesProjectPerformance = {} as facilitiesProjectPerformance;
  wkpYear: string;
  wkpYearList = [];
  ...
  constructor(
    ...
    this.genk = gen;
    this.modalService.concessionSitu.subscribe(
      res => {
        this.getBudgetData();
      }
    )
  ...
  ngOnInit(): void {
    ...
    this.oilAndGasForm = new FormGroup({
      ...
      objective_Drivers_ : new FormControl(this.oilAndGasBody.objective_Drivers_, Validators.required),
      approval_License_Permits : new FormControl(this.oilAndGasBody.approval_License_Permits, Validators.required),
      capeX_Oversight : new FormControl(this.oilAndGasBody.capeX_Oversight, Validators.required),
      budget_Performance : new FormControl(this.oilAndGasBody.budget_Performance, Validators.required),
      completion_Status : new FormControl(this.oilAndGasBody.completion_Status, Validators.required),
      conceptual : new FormControl(this.oilAndGasBody.conceptual, Validators.required),
      feed : new FormControl(this.oilAndGasBody.feed, Validators.required),
      detailed_Engineering : new FormControl(this.oilAndGasBody.detailed_Engineering, Validators.required),
      construction_Commissioning_ : new FormControl(this.oilAndGasBody.construction_Commissioning_, Validators.required),
      production_Product_Offtakers : new FormControl(this.oilAndGasBody.production_Product_Offtakers, Validators.required),
      challenges : new FormControl(this.oilAndGasBody.challenges, Validators.required),
      project_Timeline : new FormControl(this.oilAndGasBody.project_Timeline, Validators.required),
      conformity_Assessment : new FormControl(this.oilAndGasBody.conformity_Assessment, Validators.required),
      new_Technology_ : new FormControl(this.oilAndGasBody.new_Technology_, Validators.required),
      has_it_been_adopted_by_DPR_ : new FormControl(this.oilAndGasBody.has_it_been_adopted_by_DPR_, Validators.required),
      comment_ : new FormControl(this.oilAndGasBody.comment_, Validators.required),
      planned_ongoing_and_routine_maintenance : new FormControl(this.oilAndGasBody.planned_ongoing_and_routine_maintenance, Validators.required),
      actual_capital_expenditure_Current_year_NGN : new FormControl(this.oilAndGasBody.actual_capital_expenditure_Current_year_NGN, Validators.required),
      actual_capital_expenditure_Current_year_USD : new FormControl(this.oilAndGasBody.actual_capital_expenditure_Current_year_USD, Validators.required),
      proposed_Capital_Expenditure_NGN : new FormControl(this.oilAndGasBody.proposed_Capital_Expenditure_NGN, Validators.required),
      proposed_Capital_Expenditure_USD : new FormControl(this.oilAndGasBody.proposed_Capital_Expenditure_USD, Validators.required),
      project_Stage : new FormControl(this.oilAndGasBody.project_Stage, Validators.required),
      nigerian_Content_Value : new FormControl(this.oilAndGasBody.nigerian_Content_Value, Validators.required),
      product_Off_takers : new FormControl(this.oilAndGasBody.product_Off_takers, Validators.required),
      actual_Proposed : new FormControl(this.oilAndGasBody.actual_Proposed, Validators.required),
    });
    this.newTechnologyForm = new FormGroup({
      name : new FormControl(this.newTechnologyBody.name, Validators.required),
      objective : new FormControl(this.newTechnologyBody.objective, Validators.required),
      existing_Alternatives : new FormControl(this.newTechnologyBody.existing_Alternatives, Validators.required),
      dpR_Consent : new FormControl(this.newTechnologyBody.dpR_Consent, Validators.required),
    ...
    getBudgetData() {
      ...
      .subscribe(res => {
        ...
        if(res.oilCondensateTechnologyAssessment != null && res.oilCondensateTechnologyAssessment.length > 0){
          techInfo = res.oilCondensateTechnologyAssessment[0] as newTechnologyAndConformityAssessment;
          this.loadTable_Technology(res.oilCondensateTechnologyAssessment);
        }
        if(res.facilitiesProjetPerformance != null && res.facilitiesProjetPerformance.length > 0){
          facInfo = res.facilitiesProjetPerformance[0] as facilitiesProjectPerformance;
