...
import { HSE_TECHNICAL_SAFETY_CONTROL_STUDIES_NEW, HSE_SAFETY_STUDIES_NEW, HSE_MANAGEMENT_POSITION, HSE_SAFETY_CULTURE_TRAINING,
...
.subscribe(res => {
  ...
  loadTable_Management(data) {
   ...
   else{for (let item1 in this.ManagementPositionForm.controls) {
      if (item1 != 'comment') {
