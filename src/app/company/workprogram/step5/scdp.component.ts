...
import {HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_PLANNED_AND_ACTUAL ,HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_QUESTION, HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_MOU,
  ...
  ,HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_CSR_NEW_Scholarship, HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_CSR_NEW, HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_TRAINING_SCHEME
...
//#endregion
  ...
  scdp_csr_Body: HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_PLANNED_AND_ACTUAL ={} as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_PLANNED_AND_ACTUAL;
  scdp_question_Body: HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_QUESTION ={} as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_QUESTION;
  scdp_mou_Body: HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_MOU ={} as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_MOU;
  scdp_capitalprojects_Body: HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_CSR_NEW ={} as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_CSR_NEW;

  scdp_scholarship_Body: HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_SCHOLASHIP_SCHEME ={} as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_SCHOLASHIP_SCHEME;
  scdp_scholarship_csr_Body: HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_CSR_NEW_Scholarship ={} as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_CSR_NEW_Scholarship;
  scdp_trainingskills_csr_Body: HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_CSR_NEW_Training_Skill_Acquisition ={} as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_CSR_NEW_Training_Skill_Acquisition;
  ...
  ngOnInit(): void {
    this.SCDP_CSR_Form = new FormGroup(
      ...
      this.SCDP_Question_Form = new FormGroup(
        {
          have_you_submitted_all_MoUs_to_DPR: new FormControl(this.scdp_question_Body.have_you_submitted_all_MoUs_to_DPR, [Validators.required]),
          do_you_have_an_MOU_with_the_communities_for_all_your_assets: new FormControl(this.scdp_question_Body.do_you_have_an_MOU_with_the_communities_for_all_your_assets, [Validators.required]),
          if_NO_why: new FormControl(this.scdp_question_Body.if_NO_why, [Validators.required]),
          mOUResponderInPlace: new FormControl(this.scdp_question_Body.mOUResponderInPlace, [Validators.required]),
          mOUOSCPFilePath: new FormControl(this.scdp_question_Body.mOUOSCPFilePath, [Validators.required]),
          mOUResponderFilePath: new FormControl(this.scdp_question_Body.mOUResponderFilePath, [Validators.required]),
        }, {});
        this.SCDP_MOU_Form = new FormGroup(
          {
            actual_Budget_Total_Dollars: new FormControl(this.scdp_mou_Body.actual_Budget_Total_Dollars, [Validators.required]),
            beneficiary_Community: new FormControl(this.scdp_mou_Body.beneficiary_Community, [Validators.required]),
            component_of_project: new FormControl(this.scdp_mou_Body.component_of_project, [Validators.required]),
            project_Location: new FormControl(this.scdp_mou_Body.project_Location, [Validators.required]),
            status_Of_Project: new FormControl(this.scdp_mou_Body.status_Of_Project, [Validators.required]),
            type_of_project_excuted: new FormControl(this.scdp_mou_Body.type_of_project_excuted, [Validators.required]),
            year_GMou_was_signed: new FormControl(this.scdp_mou_Body.year_GMou_was_signed, [Validators.required]),
            gMOUFilePath: new FormControl(this.scdp_mou_Body.gMOUFilePath, [Validators.required])
          }, {});
          this.SCDP_CapitalProjects_Form = new FormGroup(
            {
              beneficiary_Communities: new FormControl(this.scdp_capitalprojects_Body.beneficiary_Communities, [Validators.required]),
              budget_: new FormControl(this.scdp_capitalprojects_Body.budget_, [Validators.required]),
              actual_proposed: new FormControl(this.scdp_capitalprojects_Body.actual_proposed, [Validators.required]),
              actual_Spent: new FormControl(this.scdp_capitalprojects_Body.actual_Spent, [Validators.required]),
              cSR_: new FormControl(this.scdp_capitalprojects_Body.cSR_, [Validators.required]),
          ...
          this.SCDP_Scholarship_Form = new FormGroup(
            {
              ...
              componentOfScholarship: new FormControl(this.scdp_scholarship_Body.componentOfScholarship, [Validators.required]),
              nameOfCommunity: new FormControl(this.scdp_scholarship_Body.nameOfCommunity, [Validators.required]),
            ...
            this.SCDP_Scholarship_CSR_Form = new FormGroup(
              {
                actual_proposed: new FormControl(this.scdp_scholarship_csr_Body.actual_proposed, [Validators.required]),
                actual_Spent: new FormControl(this.scdp_scholarship_csr_Body.actual_Spent, [Validators.required]),
                beneficiary_Communities_National: new FormControl(this.scdp_scholarship_csr_Body.beneficiary_Communities_National, [Validators.required]),
                beneficiary_Communities_host: new FormControl(this.scdp_scholarship_csr_Body.beneficiary_Communities_host, [Validators.required]),
                budget_: new FormControl(this.scdp_scholarship_csr_Body.budget_, [Validators.required]),
                cSR_: new FormControl(this.scdp_scholarship_csr_Body.cSR_, [Validators.required]),
                percentage_Completion_: new FormControl(this.scdp_scholarship_csr_Body.percentage_Completion_, [Validators.required])
              }, {});

              this.SCDP_TrainingSkills_CSR_Form = new FormGroup(
                {
                  actual_Spent: new FormControl(this.scdp_trainingskills_csr_Body.actual_Spent, [Validators.required]),
                  actual_proposed: new FormControl(this.scdp_trainingskills_csr_Body.actual_proposed, [Validators.required]),
                  beneficiary_Communities_National: new FormControl(this.scdp_trainingskills_csr_Body.beneficiary_Communities_National, [Validators.required]),
                  beneficiary_Communities_host: new FormControl(this.scdp_trainingskills_csr_Body.beneficiary_Communities_host, [Validators.required]),
                  budget_: new FormControl(this.scdp_trainingskills_csr_Body.budget_, [Validators.required]),
                  cSR_: new FormControl(this.scdp_trainingskills_csr_Body.cSR_, [Validators.required]),
                  percentage_Completion_: new FormControl(this.scdp_trainingskills_csr_Body.percentage_Completion_, [Validators.required]),
                }, {});

                this.SCDP_TrainingDetails_CSR_Form = new FormGroup(
                  {
                    actual_Budget_Total_Dollars: new FormControl(this.scdp_trainingdetails_csr_Body.actual_Budget_Total_Dollars, [Validators.required]),
                    componentOfTraining: new FormControl(this.scdp_trainingdetails_csr_Body.componentOfTraining, [Validators.required]),
                    statusOfTraining: new FormControl(this.scdp_trainingdetails_csr_Body.statusOfTraining, [Validators.required]),
...
saveGMOUDoc(DeFile: any) {
  ...
  if (this.GMOUFile.size < 1 || this.GMOUFile.size > 1024 * 1024 * 50) {
    this.SCDP_MOU_Form.controls['gMOUFilePath'].setErrors({ 'incorrect': true });
    this.GMOUFile = null;
    return;
  } else {
    this.SCDP_MOU_Form.controls['gMOUFilePath'].setErrors(null);
  }
  this.GMOUNewName = this.gen.getExpDoc(this.GMOUFile.name, this.GMOUFile.type);
...
saveBenefDoc(DeFile: any) {
  ...
  if (this.BenefFile.size < 1 || this.BenefFile.size > 1024 * 1024 * 50) {
    this.SCDP_Scholarship_Form.controls['sSUploadFilePath'].setErrors({ 'incorrect': true });
    this.BenefFile = null;
    return;
  } else {
    this.SCDP_Scholarship_Form.controls['sSUploadFilePath'].setErrors(null);
  }
  this.BenefNewName = this.gen.getExpDoc(this.BenefFile.name, this.BenefFile.type);
...
saveBenefDoc_2(DeFile: any) {
  ...
  if (this.Benef_2File.size < 1 || this.Benef_2File.size > 1024 * 1024 * 50) {
    this.SCDP_TrainingDetails_CSR_Form.controls['tSUploadFilePath'].setErrors({ 'incorrect': true });
    this.Benef_2File = null;
    return;
  } else {
    this.SCDP_TrainingDetails_CSR_Form.controls['tSUploadFilePath'].setErrors(null);
  }
  this.Benef_2NewName = this.gen.getExpDoc(this.Benef_2File.name, this.Benef_2File.type);
...
savePictureDoc(DeFile: any) {
  ...
  if (this.PictureFile.size < 1 || this.PictureFile.size > 1024 * 1024 * 50) {
    this.SCDP_Pictures_CSR_Form.controls['uploaded_presentation'].setErrors({ 'incorrect': true });
    this.PictureFile = null;
    return;
  } else {
    this.SCDP_Pictures_CSR_Form.controls['uploaded_presentation'].setErrors(null);
  }
  this.PictureNewName = this.gen.getExpDoc(this.PictureFile.name, this.PictureFile.type);
...
//#endregion
  ...
  SDCP_Question_Submit(){
    ...
    if (this.ResponderFile) {
      formDat.append(this.ResponderNameDoc, this.ResponderFile, this.ResponderNewName);
    }
    if (this.OSCPFile) {
      formDat.append(this.OSCPNameDoc, this.OSCPFile, this.OSCPNewName);
    }
  this.workprogram
  .post_SDCP_Question(formDat, this.genk.wpYear, this.genk.OmlName,'','', '')
  .subscribe(res => {
        ...
        this.modalService.logNotice("Success", res.message, 'success');
        this.loadTable_SDCP_Question(res.data);
        }
  ...
  .subscribe(res => {
        ...
        this.modalService.logNotice("Success", res.message, 'success');
        this.loadTable_SDCP_MOU(res.data);

        }
  })
}
SDCP_Capital_Submit(){
  let info = {} as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_CSR_NEW;
  this.scdp_capitalprojects_Body.id =  0;
  this.scdp_capitalprojects_Body.year_of_WP = this.genk.wpYear;
  this.scdp_capitalprojects_Body.oML_Name= this.genk.OmlName;
  debugger;
  for (let item in this.scdp_capitalprojects_Body) {
    if (item != 'id') {
      info[this.genk.upperText(item)] = this.scdp_capitalprojects_Body[item].toString() ?? '';

    }
  }
  debugger;
  this.workprogram
    .post_SDCP_Capital(info, this.genk.wpYear, this.genk.OmlName,'', '','')
    .subscribe(res => {
        ...
        this.modalService.logNotice("Success", res.message, 'success');
        this.loadTable_SDCP_Capital(res.data);
        }
    })
  }
  ...
  debugger;
  this.workprogram
  .post_SDCP_Scholarship(formDat, this.genk.wpYear, this.genk.OmlName,'','', '')
  .subscribe(res => {
        ...
        this.modalService.logNotice("Success", res.message, 'success');
        this.loadTable_SDCP_Sch(res.data);
        }
  })
  }
  ...
  SDCP_Scholarship_CSR_Submit(){
    ...
    this.scdp_scholarship_csr_Body.year_of_WP = this.genk.wpYear;
    this.scdp_scholarship_csr_Body.oML_Name= this.genk.OmlName;
    debugger;
    for (let item in this.scdp_scholarship_csr_Body) {
      if (item != 'id' && item != undefined) {
        info[this.genk.upperText(item)] = this.scdp_scholarship_csr_Body[item]?.toString() ?? '';

      }
    }
    this.workprogram
      .post_SDCP_Scholarship_CSR(info, this.genk.wpYear, this.genk.OmlName,'', '','')
      .subscribe(res => {
  ...
  SDCP_Training_Skills_CSR_Submit(){
    let info = {} as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_CSR_NEW_Training_Skill_Acquisition;
    this.scdp_trainingskills_csr_Body.id =  0;
    this.scdp_trainingskills_csr_Body.year_of_WP = this.genk.wpYear;
    this.scdp_trainingskills_csr_Body.oML_Name= this.genk.OmlName;
    debugger;
    for (let item in this.scdp_trainingskills_csr_Body) {
      if (item != 'id') {
        info[this.genk.upperText(item)] = this.scdp_trainingskills_csr_Body[item]?.toString() ?? '';

      }
    }
    this.workprogram
      .post_SDCP_Training_Skills_CSR(info, this.genk.wpYear, this.genk.OmlName,'', '','')
      .subscribe(res => {
  ...
  SDCP_Training_Details_CSR_Submit(){
    ...
    if (this.Benef_2File) {
      formDat.append(this.Benef_2NameDoc, this.Benef_2File, this.Benef_2NewName);
    }

  this.workprogram
  .post_SDCP_Training_Details_CSR(formDat, this.genk.wpYear, this.genk.OmlName,'','', '')
  .subscribe(res => {
        ...
        this.modalService.logNotice("Success", res.message, 'success');
        this.loadTable_SDCP_TrainingCSR(res.data);
        }
  })
  ...
  SDCP_Pictures_Submit(){
    ...
    if (this.PictureFile) {
      formDat.append(this.PictureNameDoc, this.PictureFile, this.PictureNewName);
    }

  this.workprogram
  .post_SDCP_Pictures(formDat, this.genk.wpYear, this.genk.OmlName,'','', '')
  .subscribe(res => {
        ...
        this.modalService.logNotice("Success", res.message, 'success');
        this.loadTable_SDCP_Pictures(res.data);
        }
  })
  ...
  getSCDP() {
    this.workprogram.getFormFiveSCDP(this.genk.OmlName, this.genk.fieldName, this.genk.wpYear)
    .subscribe(res => {
      ...
      let scdp_trainingdetails_csr_Info = this.scdp_trainingdetails_csr_Body as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_TRAINING_SCHEME;
      let scdp_pictures_Info = this.scdp_pictures_Body as PICTURE_UPLOAD_COMMUNITY_DEVELOPMENT_PROJECT;
      debugger;
      if(res.hseSustainable_CSR != null && res.hseSustainable_CSR.length > 0){
        scdp_csr_Info = res.hseSustainable_CSR[0] as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_PLANNED_AND_ACTUAL;
        this.loadTable_SDCP_CSR(res.hseSustainable_CSR);

      }
      if(res.hseSustainable_Question != null && res.hseSustainable_Question.length > 0){
        scdp_question_Info = res.hseSustainable_Question[0] as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_QUESTION;
        this.loadTable_SDCP_Question(res.hseSustainable_Question);
      }
      if(res.hseSustainable_MOU != null && res.hseSustainable_MOU.length > 0){
        scdp_mou_Info = res.hseSustainable_MOU[0] as HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_MOU;
        this.loadTable_SDCP_MOU(res.hseSustainable_MOU);
      }
      ...
      if(res.hseSustainable_Schorlarship_CSR != null && res.hseSustainable_Schorlarship_CSR.length > 0){
      ...
      if(res.hseSustainable_TrainingDetails_CSR != null && res.hseSustainable_TrainingDetails_CSR.length > 0){
        scdp_trainingdetails_csr_Info = res.hseSustainable_TrainingDetails_CSR[0] as  HSE_SUSTAINABLE_DEVELOPMENT_COMMUNITY_PROJECT_PROGRAM_TRAINING_SCHEME;
        this.loadTable_SDCP_TrainingCSR(res.hseSustainable_TrainingDetails_CSR);
      }
      if(res.pictureUpload != null && res.pictureUpload.length > 0){
        scdp_pictures_Info = res.pictureUpload[0] as PICTURE_UPLOAD_COMMUNITY_DEVELOPMENT_PROJECT;
  ...
  loadTable_SDCP_Question(data) {
   ...
   if(data != null){
    ...
    for (let item1 in this.SCDP_Question_Form.controls) {
      if (item1 != 'comment') {
        ...
        this.columnValue.push(this.scdp_question_Body[item1]);
      }
    }
    }
   ...
   Delete_SDCP_Question(event){
debugger;
    this.workprogram
      .post_SDCP_Question(null, this.genk.wpYear, this.genk.OmlName,'', event.target.value, "DELETE")
      .subscribe(res => {
  ...
  loadTable_SDCP_MOU(data) {
   ...
   Delete_HSE_SDCP_MOU(event){
    this.workprogram
      .post_SDCP_MOU(null, this.genk.wpYear, this.genk.OmlName,'', event.target.value, "DELETE")
      .subscribe(res => {
  ...
  Delete_SDCP_Capital(event){
    this.workprogram
      .post_SDCP_Capital(null, this.genk.wpYear, this.genk.OmlName,'', event.target.value, "DELETE")  .subscribe(res => {
  ...
  Delete_HSE_SDCP_Sch(event){
    this.workprogram
      .post_SDCP_Scholarship(null, this.genk.wpYear, this.genk.OmlName,'', event.target.value, "DELETE")  .subscribe(res => {
   ...
   Delete_HSE_SDCP_TrainingSkills(event){
    this.workprogram
      .post_SDCP_Training_Skills_CSR(null, this.genk.wpYear, this.genk.OmlName,'', event.target.value, "DELETE")  .subscribe(res => {
  ...
  Delete_HSE_SDCP_TrainingSCR(event){
    this.workprogram
      .post_SDCP_Training_Details_CSR(null, this.genk.wpYear, this.genk.OmlName,'', event.target.value, "DELETE")  .subscribe(res => {
  ...
  Delete_HSE_SDCP_Pictures(event){
    this.workprogram
      .post_SDCP_Pictures(null, this.genk.wpYear, this.genk.OmlName,'', event.target.value, "DELETE")  .subscribe(res => {
   ...
   loadTable_SDCP_CSR(data) {
    ...
    for (let item1 in this.SCDP_CSR_Form.controls) {
      if (item1 != 'comment') {
        this.columnHeader_9.push(this.genk.upperText(item1.replace(/_+/g, ' ')));
        this.columnValue_9.push(this.scdp_csr_Body[item1]);
      }
    }
  }
  ...
  Delete_SDCP_CSR(event){
    this.workprogram
      .post_SDCP_CSR(null, this.genk.wpYear, this.genk.OmlName,'', event.target.value, "DELETE")  .subscribe(res => {
