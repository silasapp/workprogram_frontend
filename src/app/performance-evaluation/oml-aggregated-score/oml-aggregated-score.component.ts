...
@Component({
  selector: 'app-oml-aggregated-score',
  templateUrl: './oml-aggregated-score.component.html',
  styleUrls: ['./oml-aggregated-score.component.scss']
})
export class OMLAggregatedScoreComponent implements OnInit {

  genk: GenericService;
  cdr: ChangeDetectorRef;
  title = 'OML AGGREGATED SCORE';
  pagenum = 0;
  selectedPage = 1;
  arrayRows = [];
  data: any[];
  year = [];
    ...
    fetchdata(e){
     ...
     this.report.performanceEvaluation("oml_aggregated_score", value).subscribe(
        (res) => {
