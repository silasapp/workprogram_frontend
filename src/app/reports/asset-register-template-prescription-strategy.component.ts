...
export class AssetRegisterTemplatePrescriptionStrategyComponent
  implements OnInit
{
  ...
  fetchdata(e) {
    ...
    this.report.fetch('prescription_stragtegy', value).subscribe((res) => {
  ...
  yearList() {
    this.report
      .getYearList('prescription_stragtegy_yearlist')
      .subscribe((res: any[]) => {
        this.year = res;
        this.cd.markForCheck();
      });
