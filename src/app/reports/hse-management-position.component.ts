...
@Component({
  selector: 'app-hse-management-position',
  templateUrl: 'ndr-report.component.html',
   styleUrls: ['./ndr-report.component.scss', '../general-report/general-report.component.scss'],

  changeDetection: ChangeDetectionStrategy.OnPush
})
export class HSEManagementPositionComponent implements OnInit {
@ViewChild('mychart', { static: false }) myChart: ElementRef<HTMLDivElement>; 
  ...
  year = [];
    ...
    fetchdata(e){
      ...
      this.report.fetch("hse_management_position", value).subscribe(
        (res) => {
    ...
    yearList() {
      this.report.getYearList("hse_management_position_yearlist")
          .subscribe((res: any[]) => {
              this.year = res;
              this.cd.markForCheck();
          });
