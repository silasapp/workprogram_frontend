...
export class HSESustainableDevelopmentCommunityNewScholarshipsComponent implements OnInit {
  @ViewChild('mychart', { static: false }) myChart: ElementRef<HTMLDivElement>; 
    ...
    yearList() {
        this.report.getYearList("hse_sustainable_development_community_new_scholarships_yearlist")
            .subscribe((res: any[]) => {
                this.year = res;
                this.cd.markForCheck();
            });
