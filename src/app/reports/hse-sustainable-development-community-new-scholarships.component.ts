...
@Component({
  selector: 'app-hse-sustainable-development-community-new-scholarships',
...
export class HSESustainableDevelopmentCommunityNewScholarshipsComponent
  implements OnInit
{
  ...
  fetchdata(e) {
    ...
    this.report
      .fetch('hse_sustainable_development_community_new_scholarships', value)
      .subscribe((res) => {
  ...
  yearList() {
    this.report
      .getYearList(
        'hse_sustainable_development_community_new_scholarships_yearlist'
      )
      .subscribe((res: any[]) => {
        this.year = res;
        this.cd.markForCheck();
