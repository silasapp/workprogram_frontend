...
export class HSESustainableDevelopmentCommunityProjectSkillComponent
  implements OnInit
{
  ...
  fetchdata(e) {
    ...
    this.report
      .fetch(
        'hse_sustainable_development_community_project_skill_acquisition',
        value
      )
      .subscribe((res) => {
  ...
  yearList() {
    this.report
      .getYearList(
        'hse_sustainable_development_community_project_skill_acquisition_yearlist'
      )
      .subscribe((res: any[]) => {
        this.year = res;
        this.cd.markForCheck();
