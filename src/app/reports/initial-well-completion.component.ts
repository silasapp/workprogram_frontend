...
@Component({
  selector: 'app-initial-well-completion',
  templateUrl: 'ndr-report.component.html',
   styleUrls: ['./ndr-report.component.scss', '../general-report/general-report.component.scss'],

  changeDetection: ChangeDetectionStrategy.OnPush
})
export class InitialWellCompletionComponent implements OnInit {
  @ViewChild('mychart', { static: false }) myChart: ElementRef<HTMLDivElement>; 
    ...
    isSpecifyColumns = false;
      ...
      {
          "columnDef": "do_you_have_approval_to_complete_the_well",
          "header": "DO YOU HAVE APPROVAL TO COMPLETE THE WELL"
      },
      {
          "columnDef": "current_year_actual_number",
    ...
    fetchdata(e){
      ...
      this.report.fetch("initial_wellcompletion", value).subscribe(
        (res) => {
    ...
    yearList() {
        this.report.getYearList("initial_wellcompletion_yearlist")
            .subscribe((res: any[]) => {
                this.year = res;
                this.cd.markForCheck();
            });
