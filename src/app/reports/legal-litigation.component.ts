...
export class LegalLitigationComponent implements OnInit {
  ...
  fetchdata(e) {
    ...
    this.report.fetch('legal_litigation', value).subscribe((res) => {
  ...
  yearList() {
    this.report
      .getYearList('legal_litigation_yearlist')
      .subscribe((res: any[]) => {
        this.year = res;
        this.cd.markForCheck();
      });
